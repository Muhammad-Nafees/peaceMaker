...
import bodyFront from '../../../assets/images/bodyFront';
import bodyBack from '../../../assets/images/bodyBack';
...
const BodyChart = ({
  ...
  useEffect(() => {
    if (onMusclePress && zoomOnPress) {
      console.warn(
        "The property 'onMusclePress' will be disabled if 'zoomOnPress' is set to true.",
      );
    }
